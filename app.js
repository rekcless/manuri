...
function renderPostsForPage(page = 1) {
  ...
  slice.forEach(item => {
    ...
    postEl.querySelector(".read").addEventListener("click", () => {
      bukaReadModal(d.judul, d.isi, d.penulis, d.waktu, d.thumbnail);
    });
...
function bukaReadModal(judul, isi, penulis, waktu, thumb){
...
/* EDIT MODAL (Level 1 - form modal with fade) */
